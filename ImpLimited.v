  ...
  - destruct H0 as [n0].
    ...
    + clear IHmulti H0 cw sw nw.
      ...
      * apply CS_AwaitTrue... apply H1...
        exists (n0 - n1).
        apply lstep_add_equally with (d:=n1).
        assert (n0 - n1 + n1 = n0); 
            [ |rewrite H2]...
        assert (n1 <= n0)...
        eapply lstep_n_monotone...
...
(* 
  A corollary of lstep_add_equally,
...
Proof with ellipsis.
  intros. exists (n0 - nw).
  apply lstep_add_equally with (d:=nw).
